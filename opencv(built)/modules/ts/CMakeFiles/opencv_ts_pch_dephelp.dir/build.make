...
modules/ts/opencv_ts_pch_dephelp.cxx: F:/opencv/sources/modules/ts/src/precomp.hpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=F:\opencv\new_build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating opencv_ts_pch_dephelp.cxx"
	cd /d F:\opencv\new_build\modules\ts && F:\CMake\bin\cmake.exe -E echo #include \"F:/opencv/sources/modules/ts/src/precomp.hpp\" > F:/opencv/new_build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /d F:\opencv\new_build\modules\ts && F:\CMake\bin\cmake.exe -E echo "int testfunction();" >> F:/opencv/new_build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /d F:\opencv\new_build\modules\ts && F:\CMake\bin\cmake.exe -E echo "int testfunction()" >> F:/opencv/new_build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /d F:\opencv\new_build\modules\ts && F:\CMake\bin\cmake.exe -E echo { >> F:/opencv/new_build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /d F:\opencv\new_build\modules\ts && F:\CMake\bin\cmake.exe -E echo "    return 0;" >> F:/opencv/new_build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /d F:\opencv\new_build\modules\ts && F:\CMake\bin\cmake.exe -E echo } >> F:/opencv/new_build/modules/ts/opencv_ts_pch_dephelp.cxx
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.obj: modules/ts/opencv_ts_pch_dephelp.cxx
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=F:\opencv\new_build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.obj"
	cd /d F:\opencv\new_build\modules\ts && C:\PROGRA~2\CODEBL~1\MinGW\bin\G__~1.EXE   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles\opencv_ts_pch_dephelp.dir\opencv_ts_pch_dephelp.cxx.obj -c F:\opencv\new_build\modules\ts\opencv_ts_pch_dephelp.cxx
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.i: cmake_force
	...
	cd /d F:\opencv\new_build\modules\ts && C:\PROGRA~2\CODEBL~1\MinGW\bin\G__~1.EXE  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E F:\opencv\new_build\modules\ts\opencv_ts_pch_dephelp.cxx > CMakeFiles\opencv_ts_pch_dephelp.dir\opencv_ts_pch_dephelp.cxx.i
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.s: cmake_force
	...
	cd /d F:\opencv\new_build\modules\ts && C:\PROGRA~2\CODEBL~1\MinGW\bin\G__~1.EXE  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S F:\opencv\new_build\modules\ts\opencv_ts_pch_dephelp.cxx -o CMakeFiles\opencv_ts_pch_dephelp.dir\opencv_ts_pch_dephelp.cxx.s
...
lib/libopencv_ts_pch_dephelp.a: modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=F:\opencv\new_build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library ..\..\lib\libopencv_ts_pch_dephelp.a"
	cd /d F:\opencv\new_build\modules\ts && $(CMAKE_COMMAND) -P CMakeFiles\opencv_ts_pch_dephelp.dir\cmake_clean_target.cmake
	cd /d F:\opencv\new_build\modules\ts && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles\opencv_ts_pch_dephelp.dir\link.txt --verbose=$(VERBOSE)
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/clean:
	cd /d F:\opencv\new_build\modules\ts && $(CMAKE_COMMAND) -P CMakeFiles\opencv_ts_pch_dephelp.dir\cmake_clean.cmake
